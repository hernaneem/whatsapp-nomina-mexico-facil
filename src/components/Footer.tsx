...
const Footer = () => {
  return (
    <footer className="bg-accent text-white pt-16 pb-8 px-4">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Guías de Uso</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Integraciones</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Actualizaciones</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">WhatsApp Directo</a></li>
        ...
        <div className="pt-8 border-t border-gray-700 text-sm text-gray-400">
          <div className="flex flex-col md:flex-row justify-between gap-4">
            <div>
              &copy; {new Date().getFullYear()} NOWA. Todos los derechos reservados.
            </div>
            <div className="flex flex-wrap gap-4">
              ...
              <a href="#" className="hover:text-gray-300">Aviso de Cookies</a>
              <a href="#" className="hover:text-gray-300">Seguridad</a>
            </div>
          </div>
        </div>
      </div>
